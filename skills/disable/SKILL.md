---
name: disable
description: Disable friction capture for you alone — this repo or all your repos; teammates unaffected
---
...
```
Friction capture is off for you in all repos on this machine — teammates are unaffected.
